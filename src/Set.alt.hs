...
selectArt Open    Diamond  = ["___  "
                             ,"╲  ╲ "
                             ," ╲  ╲"
                             ,"  ‾‾‾"]
selectArt Striped Diamond  = ["___  "
                             ,"╲╲╲╲ "
                             ," ╲╲╲╲"
                             ,"  ‾‾‾"]
selectArt Solid   Diamond  = ["___  "
                             ,"╲╳╳╲ "
                             ," ╲╳╳╲"
                             ,"  ‾‾‾"]
selectArt Open    Squiggle = ["__   "
                             ,"╲ ╲_ "
                             ," ‾╲ ╲"
                             ,"   ‾‾"]
selectArt Striped Squiggle = ["__  "
                             ,"╲╲╲_ "
                             ," ‾╲╲╲"
                             ,"   ‾‾"]
selectArt Solid   Squiggle = ["__   "
                             ,"╲╳╲_ "
                             ," ‾╲╳╲"
                             ,"   ‾‾"]
